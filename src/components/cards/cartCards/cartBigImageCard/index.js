...
const Index = (props) => {
  ...
  const [amount, setAmount] = useState(
    props.data.discountType === "Percentage"
      ? (Number(props.data.price) -
          Number(props.data.price / 100) * props.data.discountPercent) *
          Number(quantity)
      : (Number(props.data.price) - Number(props.data.discountPercent)) *
          Number(quantity)
  );
  const plus = () => {
    props.setCoupen("");
    ...
    data[props.index].discountAmount +=
      props.data.discountType === "Percentage"
        ? Number((props.data.price / 100) * props.data.discountPercent)
        : Number(props.data.discountAmount + props.data.discountPercent);
    setMyCart(data);
  ...
  const minus = () => {
    ...
    data[props.index].discountAmount =
      data[props.index].discountAmount - props.data.discountType ===
      "Percentage"
        ? Number((props.data.price / 100) * props.data.discountPercent)
        : Number(props.data.discountAmount - props.data.discountPercent);
    setMyCart(data);
      ...
      >
        ...
        >
          <Image
            ...
            source={{ uri: IMAGE_URL + props.data.image.src }}
          />
        </View>
