...
const Index = ({ navigation }) => {
  ...
  const { selectedCategory, setCurrentProduct, appearance } =
  ...
  useEffect(() => {
    axios
      .get(`${API}/product/get/category/${selectedCategory._id}`)
      .then((res) => {
    ...
    if (selectedCategory.saleId) {
      axios
        .get(`${API}/categorySale/get/single/${selectedCategory.saleId}`)
        .then(async (res) => {
