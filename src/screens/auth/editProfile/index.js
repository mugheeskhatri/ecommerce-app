...
const Index = ({ navigation }) => {
  const { user, appearance, setIsAuthenticated, setUser } =
  ...
  const updatePRofile = () => {
    ...
    axios.post(`${API}/user/update-profile`, form).then((res) => {
  ...
  const openGallery = async () => {
    ...
    if (!result.cancelled) {
      ...
      const name = nameParts[nameParts.length - 2].split("/");
  ...
  return (
    ...
    >
              ...
              >
                ...
                <TouchableOpacity
                  style={{
                    ...
                    borderColor: appearance.primaryLightColor,
                    borderRadius: 10,
                  }}
      ...
      {loading ? (
        ...
        >
          <ActivityIndicator size="large" color={appearance.secondaryColor} />
        </View>
      ) : null}
